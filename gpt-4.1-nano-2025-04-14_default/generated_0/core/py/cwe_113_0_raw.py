...
def store_info_in_header(
    ...
    '''
    # Mapping of valid info_type to corresponding header key
    valid_types = {
    ...
    if info_type in valid_types:
        try:
            # Update the header with the corresponding key
            header[valid_types[info_type]] = info_content
        except Exception:
            # In case of any error, return original header without changes
            return header
